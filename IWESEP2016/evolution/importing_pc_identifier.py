...
output: imported_pc_list.csv
        no_importing_tc_list.txt
        importing_tc_list.txt
"""
...
def no_import(tc):
    os.system('echo ' + tc + '>> no_importing_tc_list.txt')
    os.system('cat no_importing_tc_list.txt | sort | uniq > tmp.txt')
    ...
    for tc in tc_list:
        ...
        try:
            ...
            if len(imported_file_list) == 0:
                ...
                os.system('echo ' + tc + '>> importing_tc_list.txt')
                os.system('cat importing_tc_list.txt | sort | uniq > tmp.txt')
                os.system('mv tmp.txt importing_tc_list.txt')

...
#               files_integrator.py
all_code_path="C:/Users/hideshi/git/ant/src" # ソースコードが格納されているディレクトリへの絶対パス(エスケープを避けるため，パスの区切りはヌル文字ではなくスラッシュにすること．)
project_dir_name="ant_data" # 生成されたファイルを格納するためのディレクトリ
